...
HYPER_CACHE = "./hyper-cache"

MODEL_ID = "stabilityai/stable-diffusion-xl-base-1.0"
VAE_ID = "madebyollin/sdxl-vae-fp16-fix"

HYPER_SD_ID = "ByteDance/Hyper-SD"
HYPER_SD_FILE = "Hyper-SDXL-12steps-CFG-lora.safetensors"
...
class Predictor(BasePredictor):
    ...
    def load_sdxl(self):
        ...
        self.pipe.load_lora_weights(HYPER_CACHE, weight_name=HYPER_SD_FILE, local_files_only=True)
        self.pipe.fuse_lora()
    ...
    def predict(
        ...
        clip_skip: int = Input(
            description="Number of layers to be skipped from CLIP",
            default=0,
        ),
        ...
        if prompt is None:
            ...
            new_negative_prompt = "<ac_neg1>, <ac_neg2>, " + negative_prompt
