...
FLASH_REPO = "jasperai/flash-sdxl"
FLASH_ID = "pytorch_lora_weights.safetensors"
...
class Predictor(BasePredictor):
    ...
    def load_sdxl(self):
        ...
        self.pipe.load_lora_weights(TOTAL_CACHE, weight_name=FLASH_ID, local_files_only=True)
        self.pipe.fuse_lora()
